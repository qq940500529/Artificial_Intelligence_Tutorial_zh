...
[![知识点](https://img.shields.io/badge/知识点-556个-orange?style=flat-square)](#-课程体系)
...
| [数学基础](01_基础能力/02_数学基础) | 线性代数、微积分、概率论与统计（含大数定律与中心极限定理、方差分析、相关分析）、最优化、信息论 |
...
| 主题模块 | 核心内容 |
| :--- | :--- |
| [经典人工智能](02_核心原理/01_经典人工智能) | 人工智能导论、知识表示、确定性推理、不确定性推理、搜索策略、智能计算（遗传算法、粒子群、蚁群）、专家系统 |
