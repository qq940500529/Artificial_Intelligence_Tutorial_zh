...
[![课程阶段](https://img.shields.io/badge/课程阶段-5个-blue?style=flat-square)](#-课程体系)
[![主题模块](https://img.shields.io/badge/主题模块-18个-green?style=flat-square)](#-课程体系)
...
| 🏗️ 课程结构 | **5** 大阶段 · **18** 个主题模块 · **201** 个知识主题 · **897** 个知识点 |
| 📂 组织层级 | `阶段 / 主题模块 / 知识主题 / 知识点` |
| 📛 命名规则 | 全部使用中文目录名，数字前缀保持学习顺序稳定 |
| 🧭 核心原则 | 先基础后热点 · 先原理后工具 · 先验证后结论 · 先落地后扩展 |

> [!NOTE]
> 当前工作区已完成目录骨架搭建（897 个知识点目录）。课程正文内容正在**逐步填充**中，欢迎参与贡献。
...
| 主题模块 | 核心内容 |
| :--- | :--- |
| [开发环境与技术英语](01_基础能力/01_开发环境与技术英语) | 编程语言基础、命令行、虚拟环境、包管理、版本控制、Jupyter Notebook与交互式开发、调试、阅读英文文档与技术资料、字符串与编码、容器类型深入、迭代器与函数式工具、正则表达式、日期时间与日志、并发编程、网络与Web编程、Python内存模型与性能、元编程与高级特性、Python项目实践 |
| [数学基础](01_基础能力/02_数学基础) | 线性代数、微积分、概率论与统计、最优化、信息论 |
| [编程与计算机基础](01_基础能力/03_编程与计算机基础) | 数据结构、算法、面向对象编程、操作系统、计算机网络、数据库、软件工程 |
| [数值计算与科学计算](01_基础能力/04_数值计算与科学计算) | NumPy 基础、Pandas 基础、数值稳定性、SciPy 科学计算、符号计算基础 |
| [数据能力](01_基础能力/05_数据能力) | 查询语言、数据清洗、特征工程、数据可视化、实验设计、采样、数据泄漏、EDA、数据标注、文本/图像/音频预处理、数据格式与序列化 |
...
| [经典机器学习](02_核心原理/02_经典机器学习) | 回归、分类、朴素贝叶斯、KNN、树模型、核方法、集成方法、聚类、降维、偏差与方差、评估指标、交叉验证、正则化、模型选择、概率图模型、异常检测、可解释性、因果推理、时间序列、推荐系统 |
| [深度学习](02_核心原理/03_深度学习) | 神经网络、反向传播、优化器、归一化、正则化、权重初始化、损失函数、残差连接、CNN、CV 任务、序列模型、NLP 任务、注意力机制、Transformer、SSM/Mamba、自编码器、生成模型、GNN、调参排错 |
| [强化学习](02_核心原理/04_强化学习) | MDP、价值函数、TD 与 Q 学习、策略梯度、探索与利用、深度 RL、基于模型的 RL、多智能体 RL、离线 RL、逆 RL |
| [现代人工智能与大模型](02_核心原理/05_现代人工智能与大模型) | 表示学习、嵌入表示、预训练、微调、低秩适配微调、检索增强生成、对齐、推理优化、测试时计算与推理扩展、提示工程、智能体、多模态、评测、模型安全与可信性、混合专家模型、知识蒸馏、长上下文处理、合成数据、代码生成、语音大模型、视频生成与理解、3D生成与理解、世界模型、具身智能、神经符号AI |
...
| 主题模块 | 核心内容 |
| :--- | :--- |
| [人工智能工程化与部署](03_工程落地/01_人工智能工程化与部署) | 深度学习框架、实验管理、数据与模型版本控制、数据管道、模型服务、容器、云平台、图形处理器使用、分布式训练、监控、分组对照测试、成本优化、机器学习运维、特征存储、边缘部署、工作流编排、部署安全、模型测试与质量保障 |
...
| 主题模块 | 核心内容 |
| :--- | :--- |
| [研究与持续学习](04_持续研究/01_研究与持续学习) | 论文阅读、复现、基线对比、误差分析、基准测试跟踪、源码阅读、顶会跟踪、技术博客、趋势判断、科学智能、开源社区参与、技术写作、跨学科应用 |
...
flowchart LR
    ...
    class HS1,HS2,HS3,HS4,FC1,FC2,FC3,FC4,FC5,CP0,CP1,CP2,CP3,CP4,EI1,EI2,CR1,CR2 module;
```

### 🔍 完整交互式知识图谱

上面的总览图只展示阶段与主题模块的推进关系。如需查看全部 **807 个知识点**及其层级与跨分支依赖，请使用交互式可视化页面：
...
**推荐路线**：[自注意力架构](02_核心原理/03_深度学习/14_自注意力架构) → [预训练](02_核心原理/05_现代人工智能与大模型/03_预训练) → [微调](02_核心原理/05_现代人工智能与大模型/04_微调) → [RAG](02_核心原理/05_现代人工智能与大模型/06_检索增强生成) → [对齐](02_核心原理/05_现代人工智能与大模型/07_对齐) → [提示工程](02_核心原理/05_现代人工智能与大模型/10_提示工程) → [智能体](02_核心原理/05_现代人工智能与大模型/11_智能体) → [大模型应用工程](03_工程落地/02_大模型应用工程)
...
<a href="https://github.com/qq940500529/Artificial_Intelligence_Tutorial_zh">Artificial_Intelligence_Tutorial_zh</a> © 2026 by <a href="https://github.com/qq940500529">Lucky(qq940500529)</a> is licensed under <a href="https://creativecommons.org/licenses/by-nc-nd/4.0/">CC BY-NC-ND 4.0</a> <img src="https://mirrors.creativecommons.org/presskit/icons/cc.svg" width="20" height="20" alt=""><img src="https://mirrors.creativecommons.org/presskit/icons/by.svg" width="20" height="20" alt=""><img src="https://mirrors.creativecommons.org/presskit/icons/nc.svg" width="20" height="20" alt=""><img src="https://mirrors.creativecommons.org/presskit/icons/nd.svg" width="20" height="20" alt="">

<a href="https://github.com/qq940500529/Artificial_Intelligence_Tutorial_zh">Artificial_Intelligence_Tutorial_zh</a> © 2026 由 <a href="https://github.com/qq940500529">Lucky(qq940500529)</a> 创作，采用 <a href="https://creativecommons.org/licenses/by-nc-nd/4.0/">知识共享 署名—非商业性使用—禁止演绎 4.0 国际许可协议</a> 进行许可。<img src="https://mirrors.creativecommons.org/presskit/icons/cc.svg" width="20" height="20" alt=""><img src="https://mirrors.creativecommons.org/presskit/icons/by.svg" width="20" height="20" alt=""><img src="https://mirrors.creativecommons.org/presskit/icons/nc.svg" width="20" height="20" alt=""><img src="https://mirrors.creativecommons.org/presskit/icons/nd.svg" width="20" height="20" alt="">
