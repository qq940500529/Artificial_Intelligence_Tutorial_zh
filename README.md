...
[![知识点](https://img.shields.io/badge/知识点-553个-orange?style=flat-square)](#-课程体系)
...
| 🏗️ 课程结构 | **5** 大阶段 · **18** 个主题模块 · **180** 个知识主题 · **553** 个知识点 |
| 📂 组织层级 | `阶段 / 主题模块 / 知识主题 / 知识点` |
| 📛 命名规则 | 全部使用中文目录名，数字前缀保持学习顺序稳定 |
| 🧭 核心原则 | 先基础后热点 · 先原理后工具 · 先验证后结论 · 先落地后扩展 |

> [!NOTE]
> 当前工作区已完成目录骨架搭建（553 个知识点目录）。课程正文内容正在**逐步填充**中，欢迎参与贡献。
...
| 主题模块 | 核心内容 |
| :--- | :--- |
| [经典人工智能](02_核心原理/00_经典人工智能) | 人工智能导论、知识表示、确定性推理、不确定性推理、搜索策略、智能计算（遗传算法、粒子群、蚁群）、专家系统 |
| [经典机器学习](02_核心原理/01_经典机器学习) | 回归、分类、朴素贝叶斯、KNN、树模型、核方法、集成方法、聚类、降维、偏差与方差、评估指标、交叉验证、正则化、模型选择、概率图模型、异常检测、可解释性、时间序列、推荐系统 |
| [深度学习](02_核心原理/02_深度学习) | 神经网络、反向传播、优化器、归一化、正则化、权重初始化、损失函数、残差连接、CNN、CV 任务、序列模型、NLP 任务、注意力机制、Transformer、自编码器、生成模型、GNN、调参排错 |
| [强化学习](02_核心原理/03_强化学习) | MDP、价值函数、TD 与 Q 学习、策略梯度、探索与利用、深度 RL、基于模型的 RL、多智能体 RL、离线 RL、逆 RL |
| [现代人工智能与大模型](02_核心原理/04_现代人工智能与大模型) | 表示学习、嵌入、预训练、微调、LoRA、RAG、对齐、推理优化、智能体、多模态、评测、安全与可信、提示工程、MoE、知识蒸馏、长上下文、代码生成、语音大模型、视频生成、世界模型 |
...
上面的总览图只展示阶段与主题模块的推进关系。如需查看全部 **553 个知识点**及其层级与跨分支依赖，请使用交互式可视化页面：
...
**推荐路线**：[自注意力架构](02_核心原理/02_深度学习/14_自注意力架构) → [预训练](02_核心原理/04_现代人工智能与大模型/03_预训练) → [微调](02_核心原理/04_现代人工智能与大模型/04_微调) → [RAG](02_核心原理/04_现代人工智能与大模型/06_检索增强生成) → [对齐](02_核心原理/04_现代人工智能与大模型/07_对齐) → [提示工程与智能体](02_核心原理/04_现代人工智能与大模型/09_智能体) → [大模型应用工程](03_工程落地/02_大模型应用工程)
