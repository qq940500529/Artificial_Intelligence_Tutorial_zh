...
| 主题模块 | 核心内容 |
| :--- | :--- |
| [开发环境与技术英语](01_基础能力/01_开发环境与技术英语) | 编程语言基础、命令行、虚拟环境、包管理、版本控制、Jupyter Notebook、调试、阅读英文文档、字符串与编码、容器类型深入、迭代器与函数式工具、正则表达式、日期时间与日志、并发编程、网络与 Web 编程、内存模型与性能、元编程与高级特性、Python 项目实践 |
...
| [现代人工智能与大模型](02_核心原理/05_现代人工智能与大模型) | 表示学习、嵌入、预训练、微调、LoRA、RAG、对齐、推理优化、测试时计算、提示工程、智能体、多模态、评测、安全与可信、MoE、知识蒸馏、长上下文、合成数据、代码生成、语音大模型、视频生成、3D 生成、世界模型、具身智能、神经符号 AI |
...
| 主题模块 | 核心内容 |
| :--- | :--- |
| [人工智能工程化与部署](03_工程落地/01_人工智能工程化与部署) | 深度学习框架、实验管理、版本控制、数据管道、模型服务、容器、云平台、GPU 使用、分布式训练、监控、A/B 测试、成本优化、MLOps、特征存储、边缘部署、工作流编排、部署安全、模型测试 |
