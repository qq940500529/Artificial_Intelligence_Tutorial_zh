...
> **所属路径**：`01_基础能力/01_开发环境与技术英语/01_编程语言基础/06_列表推导与生成器`
> **预计学习时间**：45 分钟
> **难度等级**：⭐⭐
...
- 📖 下一个知识点：[装饰器与上下文管理器](../07_装饰器与上下文管理器/07_装饰器与上下文管理器.md) — 函数的高级用法
- 🔗 相关知识点：[迭代器与函数式工具](../../11_迭代器与函数式工具/) — 深入学习迭代器协议和 `itertools`
