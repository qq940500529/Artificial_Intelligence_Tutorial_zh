...
$$\cos\theta = \dfrac{-8}{\sqrt{14}\sqrt{21}} = \dfrac{-8}{\sqrt{294}} \approx -0.4666$$
...
$$\vec{n_1} = \overrightarrow{AB} \times \overrightarrow{AC} = (2 \times 3 - 0 \times 0, \; 0 \times (-1) - (-1) \times 3, \; (-1) \times 0 - 2 \times (-1)) = (6, 3, 2)$$

$\vec{n_2} = (0, 0, 1)$ （ $xOy$ 平面的法向量）

$$\cos\theta = \dfrac{|(6)(0) + (3)(0) + (2)(1)|}{\sqrt{36+9+4} \times 1} = \dfrac{2}{7}$$

$$\theta = \arccos\dfrac{2}{7} \approx 73.4°$$
