...
> ⚠️ **提前说明**：命令行的详细使用方法会在后续的 [命令行](../../../../01_基础能力/01_开发环境与技术英语/12_命令行/) 课程中系统学习。这里只需要了解这几个最常用的命令，能在需要时查找使用即可。
...
- 📚 拓展阅读：在后续的 [命令行](../../../../01_基础能力/01_开发环境与技术英语/12_命令行/) 课程中，你将更系统地学习 `tar`、`gzip`、`zip` 等命令行工具的使用
